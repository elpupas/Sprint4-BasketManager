...
<x-app-layout>
    ...
    <x-slot name="header">
        <x-primary-button type="submit">
            <a href="{{ route('games.index') }}">{{__('Go Back')}}</a>
        </x-primary-button>
    </x-slot>
    <div class="py-2">
        ...
        <div class="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 ">
            <div class="container mx-auto px-6 py-2">
                ...
                <form action="{{ route('games.store') }}" method="POST"
                    ...
                    <div class="mb-2 w-full">
                        <label for="" class="block text-purple--800 text-base fontsemibold mb-1 " for="game_status">{{__('Status')}}</label>
                        ...
                        <option value="lose">{{__('Lose')}}</option>
                    ...
                    >{{__('Create Game')}}</x-primary-button>
                </form>
            </div>
