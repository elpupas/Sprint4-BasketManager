        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
            ...
            @foreach ($games as $game)
                <a href="{{ route('games.show', $game) }}" class=" hover:text-purple-900">
                    <div
                        class="bg-purple-800 shadow-lg shadow-yellow-600   rounded-[127px 10px 193px 10px] border-[32px] border-double border-#531a p-4">
                        ...
                        <div class="text-center mb-4 text-yellow-400 hover:text-yellow-500">
                            <span class="font-semibold text-black ">Local:</span>
                            {{ Str::limit(Str::upper($game->localTeam->name), 9) }}
                        </div>
