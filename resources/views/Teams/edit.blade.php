    ...
    <x-app-layout>
        <x-slot name="header">
            <x-primary-button type="submit">
                <a href="{{ route('teams.show', $team) }}">Go Back</a>
            </x-primary-button>
        </x-slot>
      <div class="py-4">
        ...
        <div class="max-w-6xl mx-auto px-2 sm:px-4 md:px-4 lg:px-8 ">
                ...
                <form action="{{ route('teams.update', $team) }}" method="POST"
                    ...
                    <div class="mb-2">
                        <label class="block text-purple-800 text-base font-bold mb-1" for="confirm-password">Players</label>
                        <input
                    ...
                    <div class="mb-2">
                        <label class="block text-purple-800 text-base font-bold mb-1" for="confirm-password">Established
                            year</label>
                        <input
